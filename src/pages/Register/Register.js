        ...
        <div className='h-screen flex justify-center items-center'>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 shadow-lg" >
                ...
                >
                    ...
                    <button className="block w-full p-3 text-center rounded-sm  bg-orange-400 dark:bg-orange-800 text-white">Register</button>
                </form>
                ...
                <p className="text-xs text-center sm:px-6 dark:text-gray-400">Have an account?
                    <Link to="/login" className="underline dark:text-gray-100 pl-1">Login Now</Link>
                </p>
            </div>
        </div>
    );
